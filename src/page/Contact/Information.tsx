        ...
        <div className='flex flex-col sm:flex-row sm:justify-between py-5'>
            <div className='flex flex-col gap-2'>
                ...
                <div className='flex gap-1 items-center'>
                    <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 9 13" width="9" height="13"><defs><image width="9" height="13" id="img1" href="data:image/png;base64," /></defs><style></style><use href="#img1" x="0" y="0" /></svg><p className="textStyle text-gray-400">123 Your Address here</p>
                </div>
                <div className='flex gap-1 items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" height="0.75rem" viewBox="0 0 24 24" width="0.75rem" fill="#d9a520"><path d="M0 0h24v24H0z" fill="none" /><path d="M15.5 1h-8C6.12 1 5 2.12 5 3.5v17C5 21.88 6.12 23 7.5 23h8c1.38 0 2.5-1.12 2.5-2.5v-17C18 2.12 16.88 1 15.5 1zm-4 21c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm4.5-4H7V4h9v14z" /></svg><p className="textStyle text-gray-400">(046)123 - 456</p>
                </div>
                <div className='flex gap-1 items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" height="0.75rem" viewBox="0 0 24 24" width="0.75rem" fill="#d9a520"><path d="M0 0h24v24H0z" fill="none" /><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" /></svg><p className="textStyle text-gray-400">youremail@gmail.com</p>
                </div>
            </div>
            <div className='flex flex-col gap-2'>
                <p className=" textStyle text-gray-500 font-bold text-center sm:text-left">Working Hours:</p>
